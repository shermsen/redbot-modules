...
MONEY_BOY_QUOTES = [
    ...
    "Ich flex härter als CrossFit-Champions!",
    "YSL ist nicht nur Style, ist meine Identität!",
    "Prada Pants so clean, sie reflektieren!",
    "Swag Level überschreitet alle Messgeräte!",
    "Ich bin am drippn wie nach nem Marathon im Regen!",
    "Gucci Love ist wahre Liebe!",
    "Money Boy Energy ist wie Strom, überall fühlbar!",
    "Louis Vuitton Monogram ist mein Mantra!",
    "Turn up! Swag Frequency auf Maximum!",
    "Versace on my chest, I'm blessed, no contest!",
    "Ich bin so fresh, Frühlingstage sind neidisch!",
    "YSL Know Plug - Dein persönlicher Swag Consultant!",
    ...
    "Ich flex mit der Präzision eines Schweizer Uhrwerks!",
    ...
    "Swag Level: jenseits von Gut und Böse!",
